...
async function seedProducts() {
  try {
    ...
    console.log(`Adding ${allProducts.length} products to database...`);
    ...
    // Count by category
    const powderCount = await Product.countDocuments({ category: 'powder' });
    const liquidCount = await Product.countDocuments({ category: 'liquid' });
    const vapeCount = await Product.countDocuments({ category: 'vape' });
    
    console.log(`\nCategory breakdown:`);
    console.log(`- Powder: ${powderCount} products`);
    console.log(`- Liquid: ${liquidCount} products`);
    console.log(`- Vape: ${vapeCount} products`);
